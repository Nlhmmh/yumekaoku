...
//						.orElseThrow(() -> new UsernameNotFoundException("User " + username + " not found"));
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/api/login", "/api/register","/api/estates","/api/estates/**","api/categories","/api/categories/**","/api/media/**", "/docs/**").permitAll()
//		.antMatchers("/api/admin/**").hasRole(UserRole.admin.toString())
//        .antMatchers("/api/user/**").hasRole(UserRole.user.toString())
//        .antMatchers("/api/auth/**").hasAnyRole(UserRole.admin.toString(),UserRole.user.toString())
